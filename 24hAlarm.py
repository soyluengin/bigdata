...
def write_last24h(df, epoch_id):
    print("Fiyat değişimi son 24 saat içinde %10 oranında düşen varlıklar bilgisi")
    df.foreach(insertDb)
...
if __name__ == "__main__":
    ...
    assets24h = assets\
        .where("asset.change_24h < -10 ")
    q1 = assets24h.writeStream.foreachBatch(write_last24h).start()
#    query2 = assets1h\
#        .writeStream\
#        .outputMode("append")\
#        .format("console")\
